...
export type DokumentoversiktSelvbetjeningQuery = {
  __typename?: "Query";
  dokumentoversiktSelvbetjening: {
    ...
    journalposter: Array<{
      ...
      relevanteDatoer: Array<{ __typename?: "RelevantDato"; dato: any; datotype: Datotype } | null>;
      avsender?: {
        __typename?: "AvsenderMottaker";
        id: string;
        navn: string;
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "dokumentoversiktSelvbetjening" },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "tema" },
                value: {
                  kind: "ListValue",
                  values: [
                    { kind: "EnumValue", value: "DAG" },
                    { kind: "EnumValue", value: "OPP" },
                  ],
                },
              },
            ],
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "tema" } },
                      { kind: "Field", name: { kind: "Name", value: "tittel" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "relevanteDatoer" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "dato" } },
                            { kind: "Field", name: { kind: "Name", value: "datotype" } },
                          ],
                        },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "avsender" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "journalposttype" } },
                            ...
                            { kind: "Field", name: { kind: "Name", value: "tittel" } },
                            {
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  ...
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "brukerHarTilgang" },
                                  },
                                ],
                              },
                            },
