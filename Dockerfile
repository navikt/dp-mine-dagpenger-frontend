...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:b9a4094c946d6ce9393f720ab6aa179fa70d7e13019aa09517c0541d13bcb1ae AS runtime
WORKDIR /app
