...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:22@sha256:9ad1c81b9c8745ed686c493d3e20bbdcef8699e1a6807d83f508848fa46691d7 AS runtime
WORKDIR /app
