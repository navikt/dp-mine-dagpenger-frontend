...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:22@sha256:13ed1f9cdbd885a467feb7bbfe947c36bc9e8bde4e0479ea9bc90798b54b0120 AS runtime
WORKDIR /app
