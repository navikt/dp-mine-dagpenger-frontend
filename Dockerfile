...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:22@sha256:db118dae371b4f8a6b1f2658e72ddf4ff6f1be3a7bcb45002d47765c7d05844f AS runtime
WORKDIR /app
