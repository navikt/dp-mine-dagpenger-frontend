...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:41e9ba9c8e7ec052ba2c524a900fc396f72e2ab49d98374227bf01d703f6630c AS runtime
WORKDIR /app
