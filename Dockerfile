...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:22@sha256:729d9e74777d50d48c7a038d09851cdad20e9eec978c03d357b84664a7ca6616 AS runtime
WORKDIR /app
